...
const StudentSessions: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-3 sm:px-6 py-4 font-sans">
        ...
        <div className="space-y-4">
          {filteredBookings.map((booking) => {
            ...
            return (
              <div
                key={booking._id}
                className="bg-white p-5 rounded-2xl shadow-sm border border-gray-100 flex flex-col sm:flex-row  sm:items-center  justify-between gap-4 transition hover:shadow-md"
              >
                {/* Trainer */}
                <div className="flex items-center gap-4 w-full sm:w-auto">
                  ...
                  <div>
                    ...
                    <p className="text-[16px] sm:text-[17px] font-bold text-gray-800">
                ...
                {/* Type */}
                <div className="flex justify-between sm:flex-col sm:items-start w-full sm:w-auto">
                  <span
                ...
                {/* Time */}
                <div className="bg-gray-50 px-4 py-2 rounded-xl  w-full sm:w-auto">
