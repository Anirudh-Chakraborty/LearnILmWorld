        ...
        <div className="flex items-center gap-6 w-full md:w-auto">
          ...
          <div className="relative flex-shrink-0">
            <div className="w-24 h-24 rounded-full bg-blue-100 overflow-hidden border-2 border-white shadow-sm flex items-center justify-center">
              {previewLink ? (
                <img
                  src={previewLink} alt="Profile" className="w-full h-full object-cover"
                />
              ) : (
          ...
          <div className="flex-1 w-full max-w-lg min-h-[80px] flex flex-col justify-center">
            {isEditingPhoto ? (
              ...
              <div className="animate-fade-in">
                <h2 className="text-2xl font-bold text-gray-900">{formData.name || 'Trainer Name'}</h2>
                <div className="flex items-center gap-3 mt-2">
                  {formData.profile.languages.length > 0 && <span className="px-3 py-1 bg-blue-50 text-blue-600 text-xs font-semibold rounded-full">
                    {formData.profile.languages}
                  </span>
                  }

                  {formData.profile.specializations.length > 0 && <span className="px-3 py-1 bg-blue-50 text-blue-600 text-xs font-semibold rounded-full">
                    {formData.profile.specializations}
                  </span>
                  }

                  {formData.profile.hobbies.length > 0 && <span className="px-3 py-1 bg-blue-50 text-blue-600 text-xs font-semibold rounded-full">
                ...
                <div className="flex items-center gap-3 mt-2">
                  ...
                  <span className="flex items-center text-gray-500 text-sm gap-1">•</span>
                  <span className="flex items-center text-gray-500 text-sm gap-1">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <input
                    ...
                    className="input-field bg-white cursor-not-allowed"
                    disabled
                  />
                </div>
