    ...
    >
        ...
        <div className="mb-5 relative rounded-2xl overflow-hidden bg-[#e9f1fb]">
          {!openVideo ? (
            <>
              ...
              >
                <div className="bg-white/95 hover:bg-white p-4 rounded-full shadow-xl border border-[#5186cd]/20">
                  <Play className="h-6 w-6 text-[#1a56ad]" />
                </div>
              </button>
            </>
          ) : (
            <>
              ...
              >
                <X className="h-4 w-4 text-[#1a56ad]" />
              </button>
            </>
          )}
        </div>
        ...
        <div className="flex items-center gap-3 min-w-0">
          <div className="w-12 h-12 bg-[#e9f1fb] rounded-xl flex items-center justify-center overflow-hidden border border-[#5186cd]/20">
            {previewLink
              ...
              : <User className="h-6 w-6 text-[#1a56ad]" />}
          </div>
          <div className="min-w-0">
            ...
            <div className="flex flex-wrap items-center gap-2 text-sm text-gray-600 mt-1">
              <span className="inline-flex items-center gap-1 bg-[#fef5e4] text-[#1a56ad] px-2 py-0.5 rounded-full text-sm border border-[#5186cd]/20">
        ...
        <div className="mb-4">
          ...
          <div className="flex flex-wrap gap-2">
            {trainer.profile.specializations.slice(0, 4).map((s: any, i: number) => (
              <span key={i} className="px-3 py-1 bg-[#e9f1fb] border border-[#5186cd]/20 rounded-full text-sm text-[#1a56ad]">
                {s}
              </span>
            ))}
      ...
      <div className="flex items-center gap-6 text-gray-600 mb-5">
        <div className="flex items-center gap-2 text-sm">
          <Clock className="h-4 w-4 text-[#1a56ad]" />
          <span>{Number(trainer.profile?.experience || 5)}+ years</span>
        </div>
        <div className="flex items-center gap-2 text-sm">
          <MapPin className="h-4 w-4 text-[#1a56ad]" />
      ...
      <div className="mt-auto flex flex-wrap gap-3 justify-between items-center">
        ...
        <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
          <Link
            ...
            className="px-4 py-2 bg-white border border-[#5186cd]/20 text-[#1a56ad] rounded-full font-semibold hover:bg-[#e9f1fb] text-center transition"
          >
            View Profile
          </Link>
